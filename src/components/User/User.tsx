...
export class User extends React.Component<{},any> {
...
state = {username: ''}
   ...
   componentWillMount() {
    ...
    async loadBlockchainData() {
      ...
      const userCount = await contract.methods.users("0xE0B6e5538CE13841B19A022cA671a1177a3B7d83").call({ from: accounts[0] })
      this.setState({ username: userCount})
      console.log(userCount)
       }
      //this.setState({ userCount})
      //this.setState({ account: "userCount"})
      //console.log(userCount)
